...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "surface_damage")
        self.add_class("object", 2, "lateral")
        self.add_class("object", 3, "debris")
        self.add_class("object", 4, "joint")
        self.add_class("object", 5, "crack")
        ...
        for a in annotations:
            ...
            objects = [v['region_attributes']['class'] for s,v in a['regions'].items()]
    ...
    if image_path:
        ...
        while success:
            ...
            if success:
                ...
                class_name = ['BG', 'surface_damage', 'lateral', 'debris', 'joint', 'crack']
                # 마스킹 images
                splash=visualize.display_instances(image, r['rois'], r['masks'], r['class_ids'], 
                            class_name,r['scores'], ax=get_ax()
                            #title="Predictions"
                            )
